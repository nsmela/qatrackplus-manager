...
# 4. Clear existing installation
echo "Cleaning up any existing installation..."
rm -rf "${MANAGER_VENV}"
rm -f /usr/local/sbin/qatrackplus-manager

# 5. Create manager venv (separate from the QA Track venv)
python3 -m venv "${MANAGER_VENV}"


# 6. Install package from GitHub
